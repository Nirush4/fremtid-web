...
export const no: TranslationDictionary = {
  ...
  home: {
    ...
    contactSection: {
      ...
      packageOptions: {
        starter: 'Grunnpakke',
        growth: 'Utvidelsespakke',
        complete: 'Bedriftspakke',
      },
    ...
    packages: {
      starter: {
        ...
        features: [
          ...
          'Veiledning for domene og HTTPS-oppsett',
        ],
      },
      growth: {
        ...
        features: [
          ...
          'Opptil 5 gjennomarbeidede undersider',
          'Bildegalleri, tjenestemeny eller prisliste',
          'Direkte integrasjon mot sosiale medier',
          'Google Analytics-oppsett og optimalisert SEO',
          'Interaktiv FAQ- eller omtaleseksjon',
        ],
      },
      enterprise: {
        name: 'Bedriftspakke',
        ...
        features: [
          ...
          'Opptil 10 omfattende sider',
          'Dynamisk bloggside, artikkel- eller nyhetsdel',
          'Full SEO-revisjon og ytelsesoptimalisering',
          '1 måned gratis prioritert oppfølging og støtte',
          'Skreddersydde animasjoner og mikrodetaljer',
        ],
      },
    },
    coreInclusions: {
